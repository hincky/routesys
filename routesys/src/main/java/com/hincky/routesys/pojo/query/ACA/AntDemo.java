...
public class AntDemo {
        ...
        /**
         * 选择下一个城市
         * @param nextCityNum 需要选择第index个城市了
         * @param pheromone   全局的信息素信息
         * @param distance  全局的距离矩阵信息
         */
        public void SelectNextCity(int nextCityNum,double[][]pheromone,int[][]distance){
            double []p;
            p=new double[citys];
            double alpha=1.0;
            double beta=2.0;
            double sum=0;
            int currentcity=tour[nextCityNum-1];
            //计算公式中的分母部分
